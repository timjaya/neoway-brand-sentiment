...
sphinx-apidoc -f -e -o docs/source/apidoc/ neoway_nlp/
...
sed -i.bak '0,/neoway_nlp/s//API/' docs/source/apidoc/modules.rst
# Show package's name in the home page
sed -i.bak '0,/project/s//neoway_nlp/' docs/source/index.rst
# Delete backup files
