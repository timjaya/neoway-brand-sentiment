...
if __name__ == "__main__":
    spacy_res = pd.read_csv("D:/git_repos/neoway-brand-sentiment/NER/spacy_train.csv").loc[10]
    my_ner = sentimentAnalysis(spacy_res, sentiment_package = 'vader', parse_package = 'benepar')
    print(my_ner.rule_1())
    print(my_ner.rule_2())
    print(my_ner.rule_3())
    print(my_ner.rule_4())
